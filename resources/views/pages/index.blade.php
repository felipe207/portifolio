    ...
    <header class="masthead"
        ...
        <div class="container">
            ...
            <div class="masthead-heading text-uppercase">
                {{ @$main->title ? $main->title : 'The title' }}
            </div>
            <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger"
                href="{{ @$main->resume ? url($main->resume) : '#' }}">Resumo</a>
        </div>
    </header>
    <!-- Services-->
                    ...
                    @foreach ($abouts as $about)
                        <li>
                            <div class="timeline-image">
                                <img class="rounded-circle img-fluid" src="{{ url($about->image) }}"
                                    alt="" />
                            </div>
    ...
    <footer class="footer py-4">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-4 text-lg-left">Portifólio - Felipe Pinheiro 2023</div>
