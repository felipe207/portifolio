@section('title', 'Cadastrar servicos')
@extends('layouts.default')

@section('content')
    <ol class="breadcrumb float-xl-right">
        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
        {{-- <li class="breadcrumb-item active"><a href="javascript:;">{{ isset($servico) ? 'Atualização de servico' : 'Cadastro de servico'}}</a></li> --}}
    </ol>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="form-group w-75 col-md-1">
                            ...
                            @if (isset($servico))
                            {!! Form::checkbox('ativo', 1, $servico->ativo ?
                             true : false) !!}
                            @else
